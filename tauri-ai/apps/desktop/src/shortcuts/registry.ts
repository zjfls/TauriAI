...
export const SHORTCUT_ACTIONS: ShortcutActionDefinition[] = [
  ...
  {
    id: 'workstudio.findText',
    title: '查找代码文本（Workstudio）',
    description: '在当前聚焦编辑器中打开 Monaco 文本查找框',
    category: 'Workstudio',
    defaultMac: 'Cmd+F',
    defaultWindows: 'Ctrl+F',
    allowWhenTyping: true,
  },
  {
    id: 'workstudio.goToLine',
    title: '转到行（Workstudio）',
    description: '在当前聚焦编辑器中打开 Monaco 转到行输入框',
    category: 'Workstudio',
    defaultMac: 'Cmd+G',
    defaultWindows: 'Ctrl+G',
    allowWhenTyping: true,
  },
  {

...
pub use code_intel::{
    ...
    code_index_summary, delete_workstudio_folder_analysis, delete_workstudio_symbol_analysis,
    delete_workstudio_chat_with_records_for_file, get_workstudio_folder_analysis,
    get_workstudio_symbol_analysis, list_workstudio_chat_with_records_for_file,
